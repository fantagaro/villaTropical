<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($fname) OR empty($lname) OR empty($phone) OR empty($question) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $recipient = "fl.jasmine@gmail.com";

        // Set the email subject.
        $subject = "Questions from $fname $lname";
